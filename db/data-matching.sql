...
select osm.osm_id, closest_pt.repd_id, closest_pt.distance_meters
...
select repd.master_repd_id, osm.master_osm_id
  ...
  and osm_with_existing_repd_neighbours.repd_id = repd.repd_id
  and (osm_with_existing_repd_neighbours.repd_id_in_osm = osm_with_existing_repd_neighbours.repd_id
      or osm_with_existing_repd_neighbours.repd_id_in_osm = repd.co_location_repd_id
